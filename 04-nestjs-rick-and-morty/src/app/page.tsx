      ...
      <div className='m-8'>
        ...
        <div className='mt-8 flex justify-between'>
          <button
            ...
            disabled={!info.prev}
            className='hover: rounded  bg-green-400 px-4 py-2 text-black hover:bg-green-600 disabled:opacity-50'
          >
            Previous
          </button>
          <button
            ...
            disabled={!info.next}
            className='rounded bg-green-400  px-4 py-2 text-black hover:bg-green-600 disabled:opacity-50'
          >
            Next
          </button>
        </div>
